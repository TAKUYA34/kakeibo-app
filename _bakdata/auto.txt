...
const Home = ({ user, handleLogout, text = "Simple Money Logs..." }) => {
  // header画像のリスト
  const imagesArray = [
    ...
    <main className={styles.mainContainer}>
      ...
      <section className={styles.main2}>
        ...
        <div className={styles.main_layer2}>
          <h2 className={styles.mainTitle}>What’s New.</h2>
          <p className={styles.mainSubTitle}>最新情報</p>
